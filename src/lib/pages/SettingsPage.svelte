...
<div class="p-4 bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100">
    <div class="bg-white dark:bg-zinc-800 rounded overflow-hidden my-2 p-4">
        <h2>General</h2>
        ...
        <h2 class="mt-2 mb-1">Key Store</h2>
        <div class="flex flew-row">
            <div class="grow">
                <div class="">{secureStorePath}</div>
                <p class="text-sm text-gray-700 dark:text-gray-500 select-none cursor-default">File to store all your API Keys and credentials securely.</p>
            </div>
            <button
                on:click={saveStore}
